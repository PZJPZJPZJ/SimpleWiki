import{_ as n,c as a,a as e,o as l}from"./app-jglpLbq7.js";const p={};function i(c,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="clash-clashpremium代理核心配置" tabindex="-1"><a class="header-anchor" href="#clash-clashpremium代理核心配置"><span>Clash:ClashPremium代理核心配置</span></a></h1><h2 id="dockercli" tabindex="-1"><a class="header-anchor" href="#dockercli"><span>DockerCLI</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">--name</span> clash <span class="token parameter variable">--restart</span><span class="token operator">=</span>always <span class="token parameter variable">--net</span><span class="token operator">=</span>host dreamacro/clash-premium</span>
