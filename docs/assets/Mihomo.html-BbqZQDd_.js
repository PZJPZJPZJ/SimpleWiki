import{_ as n,c as a,a as e,o as p}from"./app-CvtnpOhv.js";const l={};function t(i,s){return p(),a("div",null,s[0]||(s[0]=[e(`<h1 id="mihomo-clashmeta代理核心配置" tabindex="-1"><a class="header-anchor" href="#mihomo-clashmeta代理核心配置"><span>Mihomo:ClashMeta代理核心配置</span></a></h1><h2 id="下载地址" tabindex="-1"><a class="header-anchor" href="#下载地址"><span>下载地址</span></a></h2><ul><li><a href="https://github.com/MetaCubeX/mihomo" target="_blank" rel="noopener noreferrer">核心程序</a></li><li><a href="https://github.com/clash-verge-rev/clash-verge-rev" target="_blank" rel="noopener noreferrer">WindowsUI</a></li><li><a href="https://github.com/MetaCubeX/ClashMetaForAndroid" target="_blank" rel="noopener noreferrer">AndroidUI</a></li></ul><h2 id="安装教程" tabindex="-1"><a class="header-anchor" href="#安装教程"><span>安装教程</span></a></h2><h3 id="windows" tabindex="-1"><a class="header-anchor" href="#windows"><span>Windows</span></a></h3><p>将<a href="#%E5%B8%B8%E7%94%A8%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">配置文件</a>命名为config.yaml，修改proxy-providers的url为订阅地址，放在<code>C:\\Users\\Admin\\.config\\mihomo</code>目录中,运行<code>mihomo.exe</code></p><h3 id="dockercompose" tabindex="-1"><a class="header-anchor" href="#dockercompose"><span>DockerCompose</span></a></h3><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre><code><span class="line"><span class="token key atrule">services</span><span class="token punctuation">:</span></span>
