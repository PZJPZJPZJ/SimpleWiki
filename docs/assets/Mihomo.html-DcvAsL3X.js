import{_ as n,c as a,a as e,o as p}from"./app-orSVnw94.js";const l={};function t(i,s){return p(),a("div",null,s[0]||(s[0]=[e(`<h1 id="mihomo-代理工具核心" tabindex="-1"><a class="header-anchor" href="#mihomo-代理工具核心"><span>Mihomo:代理工具核心</span></a></h1><h2 id="下载地址" tabindex="-1"><a class="header-anchor" href="#下载地址"><span>下载地址</span></a></h2><ul><li><a href="https://github.com/MetaCubeX/mihomo" target="_blank" rel="noopener noreferrer">MihomoCore</a></li><li><a href="https://github.com/clash-verge-rev/clash-verge-rev" target="_blank" rel="noopener noreferrer">WindowsUI</a></li><li><a href="https://github.com/MetaCubeX/ClashMetaForAndroid" target="_blank" rel="noopener noreferrer">AndroidUI</a></li></ul><h2 id="安装教程" tabindex="-1"><a class="header-anchor" href="#安装教程"><span>安装教程</span></a></h2><h3 id="windows" tabindex="-1"><a class="header-anchor" href="#windows"><span>Windows</span></a></h3><ul><li>将<a href="#%E5%B8%B8%E7%94%A8%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">配置文件</a>命名为config.yaml，修改proxy-providers的url为订阅地址，放在<code>C:\\Users\\Admin\\.config\\mihomo</code>目录中,运行<code>mihomo.exe</code></li></ul><h3 id="linux" tabindex="-1"><a class="header-anchor" href="#linux"><span>Linux</span></a></h3><ul><li>将<a href="#%E5%B8%B8%E7%94%A8%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">配置文件</a>命名为config.yaml，修改proxy-providers的url为订阅地址，放在<code>/root/.config/mihomo</code>目录中,运行<code>./mihomo</code></li></ul><h3 id="dockercompose" tabindex="-1"><a class="header-anchor" href="#dockercompose"><span>DockerCompose</span></a></h3><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre><code><span class="line"><span class="token key atrule">services</span><span class="token punctuation">:</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="tun-网卡模式-旁路网关" tabindex="-1"><a class="header-anchor" href="#tun-网卡模式-旁路网关"><span>TUN:网卡模式(旁路网关)</span></a></h3><h4 id="linux-1" tabindex="-1"><a class="header-anchor" href="#linux-1"><span>Linux</span></a></h4><h5 id="直接启动" tabindex="-1"><a class="header-anchor" href="#直接启动"><span>直接启动</span></a></h5><ul><li>宿主机运行Mihomo(系统会创建TUN网卡，自动识别出口网卡并拦截流量至Mihomo)</li></ul><h5 id="容器启动" tabindex="-1"><a class="header-anchor" href="#容器启动"><span>容器启动</span></a></h5><ul><li>Docker启用privileged特权模式(系统会创建TUN网卡，自动识别出口网卡并拦截流量至Mihomo)</li></ul><h4 id="windows-1" tabindex="-1"><a class="header-anchor" href="#windows-1"><span>Windows</span></a></h4><h5 id="直接启动-1" tabindex="-1"><a class="header-anchor" href="#直接启动-1"><span>直接启动</span></a></h5><ul><li>右键以管理员权限运行<code>mihomo.exe</code>(系统会创建TUN网卡，自动代理本机所有流量)</li></ul><h5 id="后台启动" tabindex="-1"><a class="header-anchor" href="#后台启动"><span>后台启动</span></a></h5><ol><li>在<code>mihomo.exe</code>程序所在目录创建<code>mihomo.vbs</code>输入指令保存<div class="language-vbs line-numbers-mode" data-highlighter="prismjs" data-ext="vbs" data-title="vbs"><pre><code><span class="line">set ws=WScript.CreateObject(&quot;WScript.Shell&quot;)</span>
