import{_ as n,e as a,f as e,o as l}from"./app-DaBYsrDG.js";const i={};function p(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="mysql-数据库服务端" tabindex="-1"><a class="header-anchor" href="#mysql-数据库服务端"><span>MySQL:数据库服务端</span></a></h1><h2 id="服务模式" tabindex="-1"><a class="header-anchor" href="#服务模式"><span>服务模式</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"><span class="token comment"># 进入文件夹</span></span>
