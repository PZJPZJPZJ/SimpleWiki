...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="tun-网卡模式-旁路网关" tabindex="-1"><a class="header-anchor" href="#tun-网卡模式-旁路网关"><span>TUN:网卡模式(旁路网关)</span></a></h3><h4 id="linux-1" tabindex="-1"><a class="header-anchor" href="#linux-1"><span>Linux</span></a></h4><ul><li>宿主机运行Mihomo，或Docker成功启用privileged特权模式，系统会创建TUN网卡，自动识别出口网卡并拦截流量至Mihomo</li></ul><h4 id="windows-1" tabindex="-1"><a class="header-anchor" href="#windows-1"><span>Windows</span></a></h4><ul><li>临时启动 <ol><li>以管理员权限运行Mihomo，系统会创建TUN网卡，自动代理本机所有流量</li></ol></li><li>计划任务自启动 <ol><li>此电脑右键&gt;管理&gt;计划任务程序&gt;创建任务</li><li>常规：更改用户或组&gt;输入SYSTEM&gt;检查名称&gt;确定</li><li>常规：勾选使用最高权限运行</li><li>触发器：新建&gt;选择登录时</li><li>操作：新建&gt;程序或脚本选择<code>mihomo.exe</code>&gt;添加参数<code>-d C:\\Users\\Admin\\.config\\mihomo</code>&gt;确定</li><li>保存任务即可</li></ol></li></ul><h2 id="规则配置" tabindex="-1"><a class="header-anchor" href="#规则配置"><span>规则配置</span></a></h2><h3 id="规则仓库" tabindex="-1"><a class="header-anchor" href="#规则仓库"><span>规则仓库</span></a></h3><ul><li><a href="https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/Clash" target="_blank" rel="noopener noreferrer">BlackMatrix详细规则</a></li><li><a href="https://github.com/FQrabbit/SSTap-Rule/releases" target="_blank" rel="noopener noreferrer">SSTap游戏规则</a></li><li><a href="https://github.com/v2fly/domain-list-community/tree/master/data" target="_blank" rel="noopener noreferrer">GeoSite解析</a></li><li><a href="https://github.com/Loyalsoldier/geoip/tree/release/text" target="_blank" rel="noopener noreferrer">GeoIP解析</a></li></ul><h2 id="常用配置文件" tabindex="-1"><a class="header-anchor" href="#常用配置文件"><span>常用配置文件</span></a></h2><ul><li><a href="https://wiki.metacubex.one/" target="_blank" rel="noopener noreferrer">Mihomo Wiki</a></li></ul><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre><code><span class="line"><span class="token key atrule">port</span><span class="token punctuation">:</span> <span class="token number">7890</span></span>
