import{_ as n,c as a,a as l,o as i}from"./app-DFxrZQrr.js";const e={};function c(d,s){return i(),a("div",null,s[0]||(s[0]=[l(`<h1 id="aria2-开源下载工具" tabindex="-1"><a class="header-anchor" href="#aria2-开源下载工具"><span>Aria2:开源下载工具</span></a></h1><h2 id="下载地址" tabindex="-1"><a class="header-anchor" href="#下载地址"><span>下载地址</span></a></h2><ul><li><a href="https://github.com/aria2/aria2" target="_blank" rel="noopener noreferrer">Github</a></li></ul><h2 id="使用方法" tabindex="-1"><a class="header-anchor" href="#使用方法"><span>使用方法</span></a></h2><ol><li>在软件根目录创建并配置aria2.conf文件</li><li>在软件根目录创建空白aria2.session文件</li><li>使用命令运行该程序</li><li>打开AriaNg运行浏览器图形界面</li></ol><h2 id="运行命令" tabindex="-1"><a class="header-anchor" href="#运行命令"><span>运行命令</span></a></h2><div class="language-bat line-numbers-mode" data-highlighter="prismjs" data-ext="bat" data-title="bat"><pre><code><span class="line">aria2c.exe --conf-path=aria2.conf</span>
